...
# Formula
formula <- list(c(global = "CumPercentage ~ Time + agdd * adayl + aprcp + avp + aswe + ndvi_smooth_wt1"),
                c(hazard = "CumPercentage ~ Time + agdd * adayl + aprcp + avp + aswe"),
                c(base   = "CumPercentage ~ Time + agdd * adayl"))

# Link
link <- list("logit", "probit", "cauchit", "cloglog")
